...
export function CandidaturaPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-96px)] items-center justify-center">
      <section className="w-full max-w-2xl rounded-2xl border bg-white p-6 shadow-lg">
        <h1 className="text-3xl font-black text-primary">Cadastro de Candidatura</h1>
        <p className="mt-1 text-slate-600">Preencha seus dados para se candidatar.</p>
        {phase !== 'CANDIDATURA' && (
          <p className="mt-3 rounded-lg bg-amber-100 p-3 font-semibold text-amber-800">
            A fase atual é Votação. Candidaturas podem estar bloqueadas.
          </p>
        )}
